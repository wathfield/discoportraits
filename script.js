...
const myHtml_cards = images.map(function(path_img, index) {
    var id = index+1
    return '<div class="image_container"><div class="middle"><p class="myText" id="' + id + '"></p></div><img data-src="' + path_img + '" class="lazy-loading" alt="portrait" id="images"></div>';
    }).join('');
